                    ...
                    <ul class="gray-list">
                        ...
                        <li>
                            <span class='key'>开始日期</span>
                             <span class="value" v-text="this.$route.query.startTime"></span>
                        </li>
                        <li>
                            <span class='key'>结束日期</span>
                            <span class="value" v-text="this.$route.query.endTime"></span>
                        </li>
                        <li>
...
export default {
  ...
  methods: {
    ...
    getWarehouseList() {
      ...
      var info = {
        //  whType: "1", // 成品仓
        whType: this.$route.query.whType, // 成品仓还是半成品仓
        partId: this.$route.query.partId, //只开发一个数据
        // processId: "",
        // terminalId: "",
