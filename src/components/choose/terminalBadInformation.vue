            ...
            <section class="main">
                ...
                <div class="content-box">
                    ...
                    <div class="mache-type  no-bg">
                      ...
                      <div  class='m-val'>
                         <p class="e-name" ><span v-text="this.$route.query.modelName "></span> <span>{{ this.$route.query.partName}}  {{this.$route.query.upccode}}</span></p>
                    ...
                    <ul class="m-pro-list no-bg">
                          <li class="m-pro-list-item"> 
                             ...
                             <div class="t-name">
                              ...
                              <div class="r-num">
                                <span class="num r" v-text="this.$route.query.badnessCount">80</span>
                    ...
                    <div class="form">
                        ...
                        <ul class="station-list" v-show="!showNoData">
                          ...
                          <li class="station-item" v-for="(item,index) in siteList" :key="index" @click="selectSite(item)">
                            ...
                            <div class="r-num">
                              <p class="num r" v-text="item.badnessCount">800</p>
                              <p class="tex">不良+报废</p>
                            </div>
                          </li>
...
export default {
  ...
  created() {
    console.log(this.$route.query,'23242');
   ...
   if(sessionStorage.getItem("asyncResult") && this.$route.query.asyncFlag){  
    ...
    console.log(typeof asyncData)
      ...
      this.$route.query.badnessCount = asyncData.traceContext.badnessCount;
      ...
      if (this.siteList.length == 0) {
        ...
        if (sessionStorage.getItem("siteList2")&&JSON.parse(sessionStorage.getItem("siteList2")).length!=0) {
          this.siteList = JSON.parse(sessionStorage.getItem("siteList2"));
  ...
  methods: {
    ...
    filterAll() {
      ...
      if (sessionStorage.getItem("siteList2All")) {
        this.siteList = [];
        this.siteList = JSON.parse(sessionStorage.getItem("siteList2All"));
         if(this.siteList.length==0){
  ...
  startAsyncTask: function() {
    // 发起异步请求
     const info = {
          "tracePath":"terminalBadInformation",
          "traceParams" : {
          ...
          "traceApi":"http://ks-trace/traceSort/queryBadnessInfoStation.api",
          "traceContext":{
                  ...
                  badnessCount: this.$route.query.badnessCount,
  ...
  unreadData(){
    ...
    getSite() {
      ...
      this.$axiosHttp
        .axiosPost("ks-trace/traceSort/queryBadnessInfoStation.api", data)
        .then(res => {
          console.log(res);
          clearInterval(timer);
           this.number = 0;
