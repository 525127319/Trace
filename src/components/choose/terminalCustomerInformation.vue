                    ...
                    <ul class="m-pro-list no-bg">
                          <li class="m-pro-list-item"> 
                             ...
                             <div class="t-name">
                              ...
                              <div class="r-num">
                                <span class="num" v-text="this.$route.query.totalCount">80</span>
                    ...
                    <div class="form">
                        ...
                        <ul class="station-list" v-show="!showNoData">
                          ...
                          <li class="station-item" v-for="(item,index) in siteList" :key="index" @click="selectSite(item)">
                            ...
                            <div class="r-num">
                              <p class="num" v-text="item.totalCount">800</p>
                              <p class="tex">出货量汇总</p>
                            </div>
                          </li>
...
export default {
  ...
  created() {
   ...
   if(sessionStorage.getItem("asyncResult") && this.$route.query.asyncFlag){  
    ...
    console.log(typeof asyncData)
      ...
      this.$route.query.totalCount = asyncData.traceContext.totalCount;
      ...
      if (this.siteList.length == 0) {
        this.errorMsg = "没有数据";
          ...
          if (sessionStorage.getItem("siteList3")&&JSON.parse(sessionStorage.getItem("siteList3")).length!=0) {
            this.siteList = JSON.parse(sessionStorage.getItem("siteList3"));
  ...
  methods: {
    ...
    filterAll() {
      ...
      if (sessionStorage.getItem("siteList3All")) {
        this.siteList = [];
        this.siteList = JSON.parse(sessionStorage.getItem("siteList3All"));
         if(this.siteList.length==0){
    ...
    filterData() {
      ...
      this.siteList = newArray;
        sessionStorage.setItem(
            ...
            console.log(this.siteList,'站点数据')
    },
  ...
  startAsyncTask: function() {
    // 发起异步请求
     const info = {
          "tracePath":"terminalCustomerInformation",
          "traceParams" : {
          ...
          "traceApi":"http://ks-rinse/rinse/queryCustomerInfoStation.api",
          "traceContext":{
  ...
  unreadData(){
    ...
    getSite() {
      ...
      this.$axiosHttp
        .axiosPost("ks-rinse/rinse/queryCustomerInfoStation.api", data)
        .then(res => {
          console.log(res);
          clearInterval(this.timer);
           this.number = 0;
    ...
    selectAll(event) {
      ...
      this.$router.push({
        path: "customerInformationExport",
        query: {
          partId: this.$route.query.partId,
          processId: this.$route.query.processId,
          processName: this.$route.query.processName,
