...
export default {
  ...
  methods: {
    ...
    // 选择机种,跳回上一页
     selectModels(data) {    
       console.log(data,'选择的机种');


       const partId = sessionStorage.getItem('queryPartId');
      ...
      if(this.$route.query.target =='processBadInformation'){
         this.$router.push({
          path: "/processBadInformation",
        })   
        this.$store.commit('SET_BADINFORMATION_ITEM',data);
      }else if(this.$route.query.target =='processProduction'){
          this.$router.push({
            path: "/processProduction",
          }) 
         this.$store.commit('SET_PROCESSPRODUCTION_ITEM',data);  
      }else if(this.$route.query.target =='processCustomerInformation'){
         this.$router.push({
            path: "/processCustomerInformation",
          }) 
         this.$store.commit('SET_PROCESSCUSTOMER_ITEM',data); 
      }else if(this.$route.query.target =='processInputOut'){
          this.$router.push({
            path: "/processInputOut",
          }) 
        this.$store.commit('SET_PROCESSINPUTOUT_ITEM',data); 
      }else if(this.$route.query.target =='processBadCode'){
         this.$router.push({
            path: "/processBadCode",
          }) 
         this.$store.commit('SET_PROCESSBADCODE_ITEM',data);
      } else if(this.$route.query.target =='chooseWareHouse'){
         this.$router.push({
            path: "/chooseWareHouse",
          }) 
         this.$store.commit('SET_CHOOSEWAREHOUSE_ITEM',data);
      }   
  ...
  //     if(this.$route.query.target =='processBadInformation'){
  //       this.$store.commit('SET_BADINFORMATION_ITEM',data);
  //       this.$store.commit("SET_BADINFORMATION_TYPE", this.$route.query.type);
  //       this.$store.commit("SET_BADINFORMATION_INDEX", this.$route.query.activeIndex);     
  //        this.$router.push({
  //         path: "/processBadInformation",
  //         query: {
